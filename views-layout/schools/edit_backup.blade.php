        ...
        <div class="card">
            ...
            <form action="{{ route('schools.store') }}" method="POST" enctype="multipart/form-data" class="form-horizontal r-separator">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group mb-0">
                        <div class="row align-items-center">
                            <label for="administrators" class="col-3 text-end col-form-label">Usuários Admins</label>
                            <div class="col-9 border-start pb-2 pt-2">
                                <select class="form-select @error('administrators') is-invalid @enderror" 
                                        id="administrators" 
                                        name="administrators[]" 
                                        multiple 
                                        size="5">
                                    ...
                                    <option value="{{ $user->id }}" 
                                        {{ in_array($user->id, old('administrators', [])) ? 'selected' : '' }}>
                                ...
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <small class="form-text text-muted">Segure Ctrl (ou Cmd no Mac) para selecionar múltiplos usuários</small>
                            </div>
                        </div>
                    </div>
                </div>
