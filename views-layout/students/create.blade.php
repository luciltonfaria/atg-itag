...
<div class="row">
    <div class="col-12">
        ...
        <div class="card">
            ...
            <form action="{{ route('students.store') }}" method="POST" class="form-horizontal r-separator">
                @csrf
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-9 border-start pb-2 pt-2">
                                <input type="text" class="form-control @error('external_code') is-invalid @enderror"
                                    id="external_code" name="external_code" value="{{ old('external_code') }}"
