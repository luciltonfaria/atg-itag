    ...
    <div class="position-relative z-index-5">
        <div class="row gx-0">
            ...
            <div class="col-lg-6 col-xl-5 col-xxl-4">
                <div class="min-vh-100 bg-body row justify-content-center align-items-center p-5">
                    <div class="col-12 auth-card">
                        <a href="{{ route('dashboard') }}" class="text-nowrap logo-img d-block w-100 mb-4">
                            <img src="{{ asset('assets/images/logos/logo-comprida.webp') }}" class="dark-logo" alt="Logo" style="width: 70%;" />
                        </a>
            ...
            <div class="col-lg-6 col-xl-7 col-xxl-8 position-relative overflow-hidden d-none d-lg-block"
                ...
                <div class="d-lg-flex align-items-center z-index-5 position-relative h-100">
                    <div class="row justify-content-center w-100">
                        <div class="col-lg-8 text-center">
                        <!-- Texto de boas-vindas removido para manter somente o background -->
                        </div>
                    </div>
                </div>
            </div>
